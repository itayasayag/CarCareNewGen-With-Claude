...
public class DBservices
{
	...
	//Delete USER CAR
	public int DeleteUserCar(string email, int licensePlate)
    {
        ...
        cmd = DeleteUserCarWithStoredProcedure("DeleteUserCar", con, email,licensePlate);             // create the command
    ...
    private SqlCommand DeleteUserCarWithStoredProcedure(String spName, SqlConnection con, string email, int licensePlate)
    {
	...
	public List<Reminder> ReadReminderByEmail(string email)
	{
		...
		while (dataReader.Read())
		{
			...
			r.ReminderID = (int)dataReader["reminderID"];
			r.RemindDate = (DateTime)dataReader["remindDate"];
			r.SpecificKM = (int)dataReader["SpecificKM"];
			r.Notes = dataReader["notes"].ToString();
			r.CareID= (int)dataReader["CareID"];
			r.Email= dataReader["Email"].ToString();
			r.LicensePlate= (int)dataReader["LicensePlate"];
	...
	SqlCommand CreateReminderInsertWithStoredProcedure(String spName, SqlConnection con, Reminder reminder)
	{
		...
		cmd.Parameters.AddWithValue("@specificKM", reminder.SpecificKM);
